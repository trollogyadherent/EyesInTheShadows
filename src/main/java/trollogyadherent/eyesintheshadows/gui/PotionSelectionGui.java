...
public class PotionSelectionGui extends GuiScreen {
    ...
    public PotionSelectionGui(GuiEditArrayPotionID parentScreen, Object[] beforeValues, Object[] currentValues, int index, GuiEditArrayPotionID.ReturnInfo returnInfo) {
        ...
        this.availablePotionListGui = new AvailablePotionListGui(this.mc, 410, this.height, 36, this.availablePotions, returnInfo, index);
    ...
    @Override
    public void initGui() {
        this.buttonList.add(new GuiButton(3, 20, this.height - 25, (this.width - 25) / 4, 20, I18n.format("Done")));
    }
    ...
    public boolean hasSkinEntry(PotionListEntry potionListEntry)
    {
