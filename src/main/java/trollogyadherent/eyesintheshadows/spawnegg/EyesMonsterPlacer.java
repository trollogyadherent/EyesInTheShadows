package trollogyadherent.eyesintheshadows.spawnegg;
...
public class EyesMonsterPlacer extends ItemMonsterPlacer {
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ)
    {
        ...
        {
            entityToSpawnNameFull = Tags.MODID + "." + entityToSpawnName;
            ...
            {
                EyesInTheShadows.error("Entity not found: " + entityToSpawnName);
            }
        }
